...
var teamCtrlStub = {
  ...
  addUser: 'teamCtrl.addUser',
  channelUpdate: 'teamCtrl.channelUpdate'
};
...
describe('Team API Router:', function() {
  ...
  describe('GET /api/teams/:id', function() {
    ...
    describe('POST /api/teams/addUser', function() {
      it('should route to team.controller.addUser', function() {
        expect(routerStub.post
          .withArgs('/addUser', 'teamCtrl.addUser')
          ).to.have.been.calledOnce;
      });
    });
    describe('POST /api/teams/channelUpdate', function() {
      it('should route to team.controller.channelUpdate', function() {
        expect(routerStub.post
          .withArgs('/channelUpdate', 'teamCtrl.channelUpdate')
          ).to.have.been.calledOnce;
      });
    });
