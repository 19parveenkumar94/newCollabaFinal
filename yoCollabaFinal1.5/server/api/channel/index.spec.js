...
var channelCtrlStub = {
 ...
 addUserInChannel: 'channelCtrl.addUserInChannel',
 pinChatInChannel: 'channelCtrl.pinChatInChannel',
 deleteChannel: 'channelCtrl.deleteChannel',
 addMembersInChannel: 'channelCtrl.addMembersInChannel'
...
describe('Channel API Router:', function() {
 ...
 describe('POST /api/channels/addUser', function() {
   it('should route to channel.controller.addUser', function() {
     expect(routerStub.post
       .withArgs('/addUser', 'channelCtrl.addUser')
       ).to.have.been.calledOnce;
   });
 });
 describe('POST /api/channels/addUserInChannel', function() {
   it('should route to channel.controller.addUserInChannel', function() {
     expect(routerStub.post
       .withArgs('/addUserInChannel', 'channelCtrl.addUserInChannel')
       ).to.have.been.calledOnce;
   });
 });

 describe('POST /api/channels/addMembersInChannel', function() {
   it('should route to channel.controller.addMembersInChannel', function() {
     expect(routerStub.post
       .withArgs('/addMembersInChannel', 'channelCtrl.addMembersInChannel')
       ).to.have.been.calledOnce;
   });
 });

 describe('POST /api/channels/pinChatInChannel', function() {
   it('should route to channel.controller.pinChatInChannel', function() {
     expect(routerStub.post
       .withArgs('/pinChatInChannel', 'channelCtrl.pinChatInChannel')
       ).to.have.been.calledOnce;
   });
 });

 describe('POST /api/channels/deleteChannel', function() {
   it('should route to channel.controller.deleteChannel', function() {
     expect(routerStub.post
       .withArgs('/deleteChannel', 'channelCtrl.deleteChannel')
       ).to.have.been.calledOnce;
   });
 });
